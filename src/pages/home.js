...
import { sortData, prettyPrintStat, getDate } from "../helper/util";
    ...
    <React.Fragment>
        ...
        <Card className="app__right">
          <CardContent>
            <div className="app__information">
              ...
              />
              <h3>Worldwide Vaccination</h3>
              <VaccineGraph
                classname={"app_graph"}
                country={"worldwide"}
                countryInfo={""}
                id={`worldwide-vaccine-graph`}
                casesType={casesType}
      ...
      <div
        style={{
          ...
          marginLeft: width !== "xs" && width !== "sm" ? 35 : 20,
          marginRight: width !== "xs" && width !== "sm" ? 37 : 20,
        }}
      >
        <News
          country={country}
